...
public class MovementController : MonoBehaviour
{
   [Header("Wander Settings")]
    ...
    private static List<MovementController> allNPCs = new List<MovementController>();
    ...
    public void StartNPC()
    {
        ...
        if (UnityEngine.AI.NavMesh.SamplePosition(transform.position, out hit, 1f, UnityEngine.AI.NavMesh.AllAreas))
        {
            if (col != null)
            {
    ...
    private void MoveToRandomPoint()
    {
        ...
        {
            UnityEngine.AI.NavMeshHit hit;
            if (UnityEngine.AI.NavMesh.SamplePosition(point, out hit, 5f, UnityEngine.AI.NavMesh.AllAreas))
            {
